...
### Perturbed genes
The `mdp` ranks genes according to the difference between their gene score in the test versus the control samples. The `fraction_genes` option for the `mdp` function allows you to control what fraction of these ranked genes will count as the **perturbed genes**
```{r}
